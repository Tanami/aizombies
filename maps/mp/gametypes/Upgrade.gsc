...
giveUpgradedWeapon(pos, angle, gunup)
{
	...
	if(gunup == "ump45_mp")
	{
		...
		level.upgradeweapon setModel(GetWeaponModel("ump45_akimbo_rof_mp",8));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("ump45_akimbo_rof_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "ump45_akimbo_rof_mp", level.upgradeweapon);
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("usp_silencer_xmags_mp"));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("usp_silencer_xmags_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "usp_silencer_xmags_mp", level.upgradeweapon, level.upgradeweapon2);
	...
	else if(gunup == "beretta_mp")
	{
		...
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("beretta_akimbo_xmags_mp");
		...
		level.upgradeweapon2 thread HideGunParts("beretta_akimbo_xmags_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		level.upgradeweapon2 MoveTo(pos+(3,3,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "beretta_akimbo_xmags_mp", level.upgradeweapon, level.upgradeweapon2);
		level.upgradeweapon MoveTo(pos+(0,0,10), 10);
	...
	else if(gunup == "famas_mp")
	{
		...
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("famas_acog_fmj_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self setClientDvar( "player_burstFireCooldown", "0" );
		self thread giveWeaponUpgrade(pos, "famas_acog_fmj_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	else if(gunup == "cheytac_xmags_mp")
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("cheytac_fmj_silencer_mp",6));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("cheytac_fmj_silencer_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "cheytac_fmj_silencer_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("glock_fmj_silencer_mp,8"));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("glock_fmj_silencer_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "glock_fmj_silencer_mp", level.upgradeweapon, level.upgradeweapon2);
		level.upgradeweapon MoveTo(pos+(0,0,10), 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("ak47_acog_xmags_mp",8));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("ak47_acog_xmags_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "ak47_acog_xmags_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("spas12_fmj_mp",8));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("spas12_fmj_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "spas12_fmj_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("tmp_fmj_silencer_mp",8));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("tmp_fmj_silencer_mp");
		level.upgradeweapon2 = spawn("script_model", pos+(3,3,0));
		level.upgradeweapon2 setModel(GetWeaponModel("tmp_fmj_silencer_mp",8));
		level.upgradeweapon2.angles = angle;
		level.upgradeweapon2 thread HideGunParts("tmp_fmj_silencer_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		level.upgradeweapon2 MoveTo(pos+(3,3,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "tmp_fmj_silencer_mp", level.upgradeweapon, level.upgradeweapon2);
		level.upgradeweapon MoveTo(pos, 10);
		level.upgradeweapon2 MoveTo(pos+(3,3,10), 10);
		wait 10;
		level.upgradeweapon delete();
	...
	else if(gunup == "aug_mp")
	{
		...
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("aug_eotech_xmags_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "aug_eotech_xmags_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("scar_reflex_xmags_mp",8));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("scar_reflex_xmags_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "scar_reflex_xmags_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("p90_rof_xmags_mp",4));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("p90_rof_xmags_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "p90_rof_xmags_mp", level.upgradeweapon, level.upgradeweapon2);
		level.upgradeweapon MoveTo(pos+(0,0,10), 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("m16_shotgun_xmags_mp"));
		level.upgradeweapon.angles = angle;
		self.upgrade = 1;
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "m16_shotgun_xmags_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	else if(gunup == "coltanaconda_akimbo_mp" && getdvar("mapname") == "mp_underpass")
	{
		...
		level.upgradeweapon setModel(GetWeaponModel("coltanaconda_akimbo_fmj_mp"));
		level.upgradeweapon.angles = angle;
		level.upgradeweapon thread HideGunParts("coltanaconda_akimbo_fmj_mp");
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "coltanaconda_akimbo_fmj_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	{
		level.upgradeweapon = spawn("script_model", pos);
		level.upgradeweapon setModel(GetWeaponModel("deserteagle_akimbo_fmj_mp"));
		level.upgradeweapon.angles = angle;
		self.upgrade = 1;
		wait 0.4;
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "deserteagle_akimbo_fmj_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
	...
	else if(gunup == "model1887_fmj_mp")
	{
		...
		level.upgradeweapon MoveTo(pos+(0,0,40), 2);
		wait 2;
		self thread giveWeaponUpgrade(pos, "model1887_akimbo_mp", level.upgradeweapon);
		level.upgradeweapon MoveTo(pos, 10);
		wait 10;
		level.upgradeweapon delete();
		self notify("upgrade_gone");
...
giveWeaponUpgrade(pos, weap, upgradeweapon, upgradeweapon2)
{
	...
	while(1)
	{
	    self thread  maps\mp\gametypes\BoxText::TakeUpgradeWeaponText(weap);
