...
init()
{
	...
	addCrateType( "airdrop",		"ammo", 					0,				::ammoCrateThink );
	addCrateType( "airdrop",		"uav", 						25,				::killstreakCrateThink );
	addCrateType( "airdrop",		"counter_uav", 				25,		::killstreakCrateThink );
	addCrateType( "airdrop",		"sentry", 					25,				::killstreakCrateThink );
	addCrateType( "airdrop",		"predator_missile", 		25,	::killstreakCrateThink );
	...
	addCrateType( "airdrop",		"emp", 						0,					::killstreakCrateThink );
	addCrateType( "airdrop",		"nuke", 					0,				::killstreakCrateThink );

	addCrateType( "airdrop_mega",	"ammo", 					0,				::ammoCrateThink );
	addCrateType( "airdrop_mega",	"uav", 						25,				::killstreakCrateThink );
	addCrateType( "airdrop_mega",	"counter_uav", 				25,		::killstreakCrateThink );
	addCrateType( "airdrop_mega",	"sentry", 					25,			::killstreakCrateThink );
	addCrateType( "airdrop_mega",	"predator_missile", 		25,	::killstreakCrateThink );
