...
WaypointInit()
{
	...
	level.botwaypoints[0].origin = (577,2398,84);
	level.botwaypoints[1] = SpawnStruct();
	level.botwaypoints[1].origin = (1616,2496,75);
	level.botwaypoints[2] = SpawnStruct();
	level.botwaypoints[2].origin = (1625,3240,80);
	level.botwaypoints[3] = SpawnStruct();
	level.botwaypoints[3].origin = (683,3222,79);
	level.botwaypoints[4] = SpawnStruct();
	level.botwaypoints[4].origin = (618,2783,78);
	level.botwaypoints[5] = SpawnStruct();
	level.botwaypoints[5].origin = (924,2687,80);
	level.botwaypoints[6] = SpawnStruct();
	level.botwaypoints[6].origin = (1148,2925,83);
	level.botwaypoints[7] = SpawnStruct();
	level.botwaypoints[7].origin = (1510,2917,82);
	level.botwaypoints[8] = SpawnStruct();
	level.botwaypoints[8].origin = (1666,2930,74);
	level.botwaypoints[9] = SpawnStruct();
	level.botwaypoints[9].origin = (1437,3096,82);
	level.botwaypoints[10] = SpawnStruct();
	level.botwaypoints[10].origin = (1219,3115,82);
	level.botwaypoints[11] = SpawnStruct();
	level.botwaypoints[11].origin = (1502,2320,64);
	level.botwaypoints[12] = SpawnStruct();
	level.botwaypoints[12].origin = (232,2730,116);
	level.botwaypoints[13] = SpawnStruct();
	level.botwaypoints[13].origin = (282,2479,150);
	level.botwaypoints[14] = SpawnStruct();
	level.botwaypoints[14].origin = (611,2200,103);
	level.botwaypoints[15] = SpawnStruct();
	level.botwaypoints[15].origin = (654,3296,75);
}